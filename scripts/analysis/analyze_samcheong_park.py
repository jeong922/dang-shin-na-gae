...
for candidate in seoul_candidates:
    ...
    if not is_samcheong_name(candidate["name"]):
        continue
...
if not found_name_candidate:
    ...
    print("삼청 이름 후보가 없습니다.")


# ============================================================
# 현재 Polygon 내부 OSM 공원 확인
# ============================================================
#
# OSM 삼청공원이 현재 서울시 Polygon의
# 일부 공간만 표현하는지 확인하기 위한 출력.
# ============================================================
...
if not inside_osm:
    ...
    print("현재 Polygon 내부에 대부분 포함되는 " "OSM 후보가 없습니다.")
