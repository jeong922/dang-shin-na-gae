...
# ============================================================
# 현재 Polygon 내부 관련 OSM 후보
# ============================================================

print()
print("=" * 70)
print("현재 Polygon 내부 관련 OSM 후보")
print("=" * 70)
...
if not inside_osm:
    ...
    print("현재 Polygon 내부에 대부분 포함되는 " "관련 OSM 후보가 없습니다.")


for candidate in inside_osm:
